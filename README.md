...
<p align="center">
  <img src="Images/banner-01-scaled.jpg" width="100%" />
</p>


[![Project Status](https://img.shields.io/badge/Status-In_Progress-yellowgreen.svg)]()  ![License](https://img.shields.io/badge/License-MIT-blue)  ![Updated](https://img.shields.io/badge/Updated-Today-brightgreen)  ![Language](https://img.shields.io/badge/Markdown-100%25-lightgrey)  ![Level](https://img.shields.io/badge/Exam-CCNA_200--301-red)
...
🔍 **Explore**: Navigate through the folders and .md (Markdown) files to find the specific topic you need to review.
✍️ **Contribute** (Optional): If you find an error or have a clearer way to explain a concept, feel free to open a Pull Request!
🧪 **Labs**: Check the Labs/ section for configuration examples of key Cisco IOS commands (often referencing Packet Tracer files).
...
If you have any questions or want to connect with other students:
  ...
  * **GitHub:** [@luissanher365](https://github.com/luissanher365)
